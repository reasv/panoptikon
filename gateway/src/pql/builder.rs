...
use crate::pql::model::{
    Column, EntityType, HasUnprocessedData, InBookmarks, Match, MatchPath, MatchTags, MatchText,
    OrderArgs, OrderByField, OrderDirection, PqlQuery, ProcessedBy, QueryElement, Rrf,
};
...
fn build_match_filter(
    ...
    Err(PqlError::invalid("Match filter not implemented"))
}
...
fn build_match_path_filter(
    ...
    Err(PqlError::invalid("MatchPath filter not implemented"))
}

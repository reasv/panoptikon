...
from panoptikon.ui.components.gallery_view import (
    GalleryView,
    create_gallery_view,
)
from panoptikon.ui.components.list_view import ImageList, create_image_list
...
def on_selected_files_change(
    ...
    selection_history: List[FileSearchResult],
):
...
def create_multiview(
    ...
    files.change(fn=on_files_change, inputs=[], outputs=[selected_files])

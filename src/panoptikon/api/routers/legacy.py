...
@router.get("/bookmarks/{bookmarks_namespace}/", response_class=HTMLResponse)
...
@router.get(
    "/api/bookmarks/{bookmarks_namespace}/", response_class=JSONResponse
)
...
@router.get("/search/tags", response_class=HTMLResponse)
...
@router.get("/api/search/tags", response_class=JSONResponse)
...
@router.get("/browse/{foldername:path}/", response_class=HTMLResponse)

...
def create_root_UI():
    with gr.Blocks(css="static/style.css", fill_height=True) as ui:
        ...
        with gr.Tabs():
            ...
            create_semantic_search_UI(select_history, bookmarks_namespace=bookmarks_namespace)
            create_semantic_text_search_UI(select_history, bookmarks_namespace=bookmarks_namespace)

...
def create_semantic_text_search_UI(
        ...
        with gr.Column(elem_classes="centered-content", scale=0):
            with gr.Row():
                ...
                with gr.Column():
                    ...
                    enable_semantic_search = gr.Checkbox(label="Semantic Search", value=True, scale=1, interactive=False)
                    enable_full_text_search = gr.Checkbox(label="Require text to include query", value=False, scale=1)
    ...
    def search_by_text(search_text: str, n_results: int, semantic_search: bool = False, full_text_search: bool = False):
    ...
    submit_button.click(
        fn=search_by_text,
        inputs=[search_text, n_results, enable_semantic_search, enable_full_text_search],

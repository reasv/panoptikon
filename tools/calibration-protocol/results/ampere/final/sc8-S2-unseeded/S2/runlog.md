# Scenario S2 - run final/sc8-S2-unseeded
...
| Run id | final/sc8-S2-unseeded |
| Date (UTC) | 2026-09-17T02:11:36.384055+00:00 |
| Host | systemvi |
...
```bash
# results dir
DIR=$(python/.venv/bin/python tools/calibration-protocol/newrun.py --scenario S2 --run-id final/sc8-S2-unseeded)

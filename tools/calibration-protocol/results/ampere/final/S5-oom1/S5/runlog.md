...
| Run id | final/S5-oom1 |
| Date (UTC) | 2026-09-17T01:53:03.318983+00:00 |
| Host | systemvi |
...
```bash
# results dir
DIR=$(python/.venv/bin/python tools/calibration-protocol/newrun.py --scenario S5 --run-id final/S5-oom1)

...
| Run id | final/S4b |
| Date (UTC) | 2026-09-17T01:23:22.412871+00:00 |
| Host | systemvi |
...
```bash
# results dir
DIR=$(python/.venv/bin/python tools/calibration-protocol/newrun.py --scenario S4b --run-id final/S4b)

# Scenario S14 - run final/S14-tags
...
| Run id | final/S14-tags |
| Date (UTC) | 2026-09-17T01:07:27.250337+00:00 |
| Host | systemvi |
...
```bash
# results dir
DIR=$(python/.venv/bin/python tools/calibration-protocol/newrun.py --scenario S14 --run-id final/S14-tags)

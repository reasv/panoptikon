# Scenario S14-textembed - run final/S14-textembed
...
| Configuration | C1 (see protocol §3) |
| Run id | final/S14-textembed |
| Date (UTC) | 2026-09-17T02:06:46.511274+00:00 |
| Host | systemvi |
| Branch / commit | final / 2133563f722478822d17b62430a19e363f47cbd6 |
...
| Driver | 580.159.03 |
| GPUs | 0:NVIDIA GeForce RTX 3090 24576 MiB |
...
```bash
# results dir
DIR=$(python/.venv/bin/python tools/calibration-protocol/newrun.py --scenario S14-textembed --run-id final/S14-textembed)

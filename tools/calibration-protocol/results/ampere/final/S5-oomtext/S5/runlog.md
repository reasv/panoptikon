# Scenario S5 - run final/S5-oomtext
...
| Run id | final/S5-oomtext |
| Date (UTC) | 2026-09-17T01:56:09.238685+00:00 |
| Host | systemvi |
...
```bash
# results dir
DIR=$(python/.venv/bin/python tools/calibration-protocol/newrun.py --scenario S5 --run-id final/S5-oomtext)

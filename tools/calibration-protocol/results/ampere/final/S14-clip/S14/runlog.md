# Scenario S14 - run final/S14-clip
...
| Run id | final/S14-clip |
| Date (UTC) | 2026-09-17T02:01:40.890050+00:00 |
| Host | systemvi |
...
```bash
# results dir
DIR=$(python/.venv/bin/python tools/calibration-protocol/newrun.py --scenario S14 --run-id final/S14-clip)

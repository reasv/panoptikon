# Scenario S2 - run final/S2-wdvit
...
| Run id | final/S2-wdvit |
| Date (UTC) | 2026-09-17T01:11:26.606443+00:00 |
| Host | systemvi |
...
```bash
# results dir
DIR=$(python/.venv/bin/python tools/calibration-protocol/newrun.py --scenario S2 --run-id final/S2-wdvit)

# Scenario S4a - run final/sc8-S4a
...
| Run id | final/sc8-S4a |
| Date (UTC) | 2026-09-17T02:17:51.224959+00:00 |
| Host | systemvi |
...
```bash
# results dir
DIR=$(python/.venv/bin/python tools/calibration-protocol/newrun.py --scenario S4a --run-id final/sc8-S4a)

# Scenario S4a - run final/sc8-S4a-repeat
...
| Run id | final/sc8-S4a-repeat |
| Date (UTC) | 2026-09-17T02:21:46.474076+00:00 |
| Host | systemvi |
...
```bash
# results dir
DIR=$(python/.venv/bin/python tools/calibration-protocol/newrun.py --scenario S4a --run-id final/sc8-S4a-repeat)

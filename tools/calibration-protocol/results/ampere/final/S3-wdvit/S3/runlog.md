# Scenario S3 - run final/S3-wdvit
...
| Run id | final/S3-wdvit |
| Date (UTC) | 2026-09-17T01:16:28.392361+00:00 |
| Host | systemvi |
...
```bash
# results dir
DIR=$(python/.venv/bin/python tools/calibration-protocol/newrun.py --scenario S3 --run-id final/S3-wdvit)

# Scenario S14 - run final/sc8-S14-flor
...
| Run id | final/sc8-S14-flor |
| Date (UTC) | 2026-09-17T02:16:16.513875+00:00 |
| Host | systemvi |
...
```bash
# results dir
DIR=$(python/.venv/bin/python tools/calibration-protocol/newrun.py --scenario S14 --run-id final/sc8-S14-flor)

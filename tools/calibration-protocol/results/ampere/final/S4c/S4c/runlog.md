...
| Run id | final/S4c |
| Date (UTC) | 2026-09-17T01:30:36.681165+00:00 |
| Host | systemvi |
...
```bash
# results dir
DIR=$(python/.venv/bin/python tools/calibration-protocol/newrun.py --scenario S4c --run-id final/S4c)

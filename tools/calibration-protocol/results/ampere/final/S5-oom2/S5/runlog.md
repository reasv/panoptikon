...
| Run id | final/S5-oom2 |
| Date (UTC) | 2026-09-17T01:52:02.452629+00:00 |
| Host | systemvi |
...
```bash
# results dir
DIR=$(python/.venv/bin/python tools/calibration-protocol/newrun.py --scenario S5 --run-id final/S5-oom2)

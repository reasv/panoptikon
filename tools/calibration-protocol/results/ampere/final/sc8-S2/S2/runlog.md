...
| Run id | final/sc8-S2 |
| Date (UTC) | 2026-09-17T02:09:05.606896+00:00 |
| Host | systemvi |
...
```bash
# results dir
DIR=$(python/.venv/bin/python tools/calibration-protocol/newrun.py --scenario S2 --run-id final/sc8-S2)

# Scenario S2 - run final/S2-wdvit-unseeded
...
|---|---|
| Scenario | S2 |
| Configuration | /home/moot/projects/panoptikon/tools/calibration-protocol/results/final/server-C1u.toml (see protocol §3) |
| Run id | final/S2-wdvit-unseeded |
| Date (UTC) | 2026-09-17T01:13:59.537672+00:00 |
| Host | systemvi |
...
```bash
# results dir
DIR=$(python/.venv/bin/python tools/calibration-protocol/newrun.py --scenario S2 --run-id final/S2-wdvit-unseeded)

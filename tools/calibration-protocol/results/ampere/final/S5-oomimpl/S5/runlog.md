# Scenario S5 - run final/S5-oomimpl
...
| Run id | final/S5-oomimpl |
| Date (UTC) | 2026-09-17T02:20:03.757680+00:00 |
| Host | systemvi |
...
```bash
# results dir
DIR=$(python/.venv/bin/python tools/calibration-protocol/newrun.py --scenario S5 --run-id final/S5-oomimpl)

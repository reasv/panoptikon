# Scenario S4d - run final/S4d-repeat
...
| Run id | final/S4d-repeat |
| Date (UTC) | 2026-09-17T01:44:59.024028+00:00 |
| Host | systemvi |
...
```bash
# results dir
DIR=$(python/.venv/bin/python tools/calibration-protocol/newrun.py --scenario S4d --run-id final/S4d-repeat)

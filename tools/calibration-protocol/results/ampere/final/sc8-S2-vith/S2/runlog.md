# Scenario S2 - run final/sc8-S2-vith
...
| Run id | final/sc8-S2-vith |
| Date (UTC) | 2026-09-17T02:14:05.296667+00:00 |
| Host | systemvi |
...
```bash
# results dir
DIR=$(python/.venv/bin/python tools/calibration-protocol/newrun.py --scenario S2 --run-id final/sc8-S2-vith)

# Scenario S14 - run final/S14-florence2
...
| Run id | final/S14-florence2 |
| Date (UTC) | 2026-09-17T02:05:13.709963+00:00 |
| Host | systemvi |
...
```bash
# results dir
DIR=$(python/.venv/bin/python tools/calibration-protocol/newrun.py --scenario S14 --run-id final/S14-florence2)

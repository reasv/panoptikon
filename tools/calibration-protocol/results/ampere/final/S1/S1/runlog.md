...
| Run id | final/S1 |
| Date (UTC) | 2026-09-17T01:10:03.847079+00:00 |
| Host | systemvi |
...
```bash
# results dir
DIR=$(python/.venv/bin/python tools/calibration-protocol/newrun.py --scenario S1 --run-id final/S1)

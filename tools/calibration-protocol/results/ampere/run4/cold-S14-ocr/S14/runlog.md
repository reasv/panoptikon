...
| Run id | cold-S14-ocr |
| Date (UTC) | 2026-09-16T20:15:02.242868+00:00 |
| Host | systemvi |
...
```bash
# results dir
DIR=$(python/.venv/bin/python tools/calibration-protocol/newrun.py --scenario S14 --run-id cold-S14-ocr)

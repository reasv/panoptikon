# Scenario S5 - run S5-oomtimed-8k
...
| Run id | S5-oomtimed-8k |
| Date (UTC) | 2026-09-16T20:23:44.487079+00:00 |
| Host | systemvi |
...
```bash
# results dir
DIR=$(python/.venv/bin/python tools/calibration-protocol/newrun.py --scenario S5 --run-id S5-oomtimed-8k)

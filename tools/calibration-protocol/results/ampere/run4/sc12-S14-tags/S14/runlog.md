# Scenario S14 - run sc12-S14-tags
...
| Run id | sc12-S14-tags |
| Date (UTC) | 2026-09-16T19:46:22.820056+00:00 |
| Host | systemvi |
...
```bash
# results dir
DIR=$(python/.venv/bin/python tools/calibration-protocol/newrun.py --scenario S14 --run-id sc12-S14-tags)

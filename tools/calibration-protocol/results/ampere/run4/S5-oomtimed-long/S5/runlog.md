# Scenario S5 - run S5-oomtimed-long
...
| Run id | S5-oomtimed-long |
| Date (UTC) | 2026-09-16T20:09:01.563911+00:00 |
| Host | systemvi |
...
```bash
# results dir
DIR=$(python/.venv/bin/python tools/calibration-protocol/newrun.py --scenario S5 --run-id S5-oomtimed-long)

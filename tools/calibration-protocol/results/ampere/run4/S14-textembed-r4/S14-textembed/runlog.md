# Scenario S14-textembed - run S14-textembed-r4
...
| Run id | S14-textembed-r4 |
| Date (UTC) | 2026-09-16T19:53:06.233198+00:00 |
| Host | systemvi |
...
```bash
# results dir
DIR=$(python/.venv/bin/python tools/calibration-protocol/newrun.py --scenario S14-textembed --run-id S14-textembed-r4)

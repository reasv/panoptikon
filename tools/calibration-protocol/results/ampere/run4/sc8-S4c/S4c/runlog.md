...
| Run id | sc8-S4c |
| Date (UTC) | 2026-09-16T19:16:17.394594+00:00 |
| Host | systemvi |
...
```bash
# results dir
DIR=$(python/.venv/bin/python tools/calibration-protocol/newrun.py --scenario S4c --run-id sc8-S4c)

...
| Run id | S5-oom2 |
| Date (UTC) | 2026-09-16T18:50:22.956665+00:00 |
| Host | systemvi |
...
```bash
# results dir
DIR=$(python/.venv/bin/python tools/calibration-protocol/newrun.py --scenario S5 --run-id S5-oom2)

...
| Run id | sc12-S2 |
| Date (UTC) | 2026-09-16T19:34:12.329134+00:00 |
| Host | systemvi |
...
```bash
# results dir
DIR=$(python/.venv/bin/python tools/calibration-protocol/newrun.py --scenario S2 --run-id sc12-S2)

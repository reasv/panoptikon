...
| Run id | S3-wdvit |
| Date (UTC) | 2026-09-16T18:22:36.033903+00:00 |
| Host | systemvi |
...
```bash
# results dir
DIR=$(python/.venv/bin/python tools/calibration-protocol/newrun.py --scenario S3 --run-id S3-wdvit)

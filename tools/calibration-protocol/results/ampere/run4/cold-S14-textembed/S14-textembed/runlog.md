# Scenario S14-textembed - run cold-S14-textembed
...
| Run id | cold-S14-textembed |
| Date (UTC) | 2026-09-16T20:20:14.050332+00:00 |
| Host | systemvi |
| Branch / commit | run4 / 0d7f567185288d83974a1f10d21fff0e6e44677b |
...
```bash
# results dir
DIR=$(python/.venv/bin/python tools/calibration-protocol/newrun.py --scenario S14-textembed --run-id cold-S14-textembed)

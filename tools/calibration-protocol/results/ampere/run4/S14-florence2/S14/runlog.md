# Scenario S14 - run S14-florence2
...
| Run id | S14-florence2 |
| Date (UTC) | 2026-09-16T19:04:31.931393+00:00 |
| Host | systemvi |
...
```bash
# results dir
DIR=$(python/.venv/bin/python tools/calibration-protocol/newrun.py --scenario S14 --run-id S14-florence2)

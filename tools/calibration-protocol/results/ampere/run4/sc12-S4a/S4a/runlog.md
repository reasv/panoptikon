...
| Run id | sc12-S4a |
| Date (UTC) | 2026-09-16T19:36:37.207176+00:00 |
| Host | systemvi |
...
```bash
# results dir
DIR=$(python/.venv/bin/python tools/calibration-protocol/newrun.py --scenario S4a --run-id sc12-S4a)

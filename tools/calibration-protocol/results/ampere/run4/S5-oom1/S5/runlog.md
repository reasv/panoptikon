...
| Run id | S5-oom1 |
| Date (UTC) | 2026-09-16T18:51:15.804037+00:00 |
| Host | systemvi |
...
```bash
# results dir
DIR=$(python/.venv/bin/python tools/calibration-protocol/newrun.py --scenario S5 --run-id S5-oom1)

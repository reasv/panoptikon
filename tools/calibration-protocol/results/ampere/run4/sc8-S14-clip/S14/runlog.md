...
| Run id | sc8-S14-clip |
| Date (UTC) | 2026-09-16T19:24:26.309710+00:00 |
| Host | systemvi |
...
```bash
# results dir
DIR=$(python/.venv/bin/python tools/calibration-protocol/newrun.py --scenario S14 --run-id sc8-S14-clip)

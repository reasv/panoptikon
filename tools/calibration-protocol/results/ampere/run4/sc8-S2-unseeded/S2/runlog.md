# Scenario S2 - run sc8-S2-unseeded
...
| Run id | sc8-S2-unseeded |
| Date (UTC) | 2026-09-16T19:29:05.787159+00:00 |
| Host | systemvi |
...
```bash
# results dir
DIR=$(python/.venv/bin/python tools/calibration-protocol/newrun.py --scenario S2 --run-id sc8-S2-unseeded)

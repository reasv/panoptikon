...
| Run id | S2-wdvit |
| Date (UTC) | 2026-09-16T18:17:42.365213+00:00 |
| Host | systemvi |
...
```bash
# results dir
DIR=$(python/.venv/bin/python tools/calibration-protocol/newrun.py --scenario S2 --run-id S2-wdvit)

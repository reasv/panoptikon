...
| Run id | sc8-S4a |
| Date (UTC) | 2026-09-16T19:13:37.598252+00:00 |
| Host | systemvi |
...
```bash
# results dir
DIR=$(python/.venv/bin/python tools/calibration-protocol/newrun.py --scenario S4a --run-id sc8-S4a)

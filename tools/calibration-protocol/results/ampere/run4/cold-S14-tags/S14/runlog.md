# Scenario S14 - run cold-S14-tags
...
| Run id | cold-S14-tags |
| Date (UTC) | 2026-09-16T20:12:44.143673+00:00 |
| Host | systemvi |
...
```bash
# results dir
DIR=$(python/.venv/bin/python tools/calibration-protocol/newrun.py --scenario S14 --run-id cold-S14-tags)

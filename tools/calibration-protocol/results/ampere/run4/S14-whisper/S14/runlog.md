...
| Run id | S14-whisper |
| Date (UTC) | 2026-09-16T19:03:37.123913+00:00 |
| Host | systemvi |
...
```bash
# results dir
DIR=$(python/.venv/bin/python tools/calibration-protocol/newrun.py --scenario S14 --run-id S14-whisper)

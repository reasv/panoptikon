# Scenario S14 - run cold-S14-vith
...
| Run id | cold-S14-vith |
| Date (UTC) | 2026-09-16T20:18:42.644397+00:00 |
| Host | systemvi |
...
```bash
# results dir
DIR=$(python/.venv/bin/python tools/calibration-protocol/newrun.py --scenario S14 --run-id cold-S14-vith)

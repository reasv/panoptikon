# Scenario S4a - run sc8-S4a-unseeded
...
| Run id | sc8-S4a-unseeded |
| Date (UTC) | 2026-09-16T19:31:26.514359+00:00 |
| Host | systemvi |
...
```bash
# results dir
DIR=$(python/.venv/bin/python tools/calibration-protocol/newrun.py --scenario S4a --run-id sc8-S4a-unseeded)

# Scenario S14 - run cold-S14-whisper
...
| Run id | cold-S14-whisper |
| Date (UTC) | 2026-09-16T20:16:07.064328+00:00 |
| Host | systemvi |
...
```bash
# results dir
DIR=$(python/.venv/bin/python tools/calibration-protocol/newrun.py --scenario S14 --run-id cold-S14-whisper)

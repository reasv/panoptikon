...
| Run id | sc8-S14-tags |
| Date (UTC) | 2026-09-16T19:23:19.576535+00:00 |
| Host | systemvi |
...
```bash
# results dir
DIR=$(python/.venv/bin/python tools/calibration-protocol/newrun.py --scenario S14 --run-id sc8-S14-tags)

# Scenario S2 - run S2-wdvit-unseeded
...
| Run id | S2-wdvit-unseeded |
| Date (UTC) | 2026-09-16T18:20:07.202636+00:00 |
| Host | systemvi |
...
```bash
# results dir
DIR=$(python/.venv/bin/python tools/calibration-protocol/newrun.py --scenario S2 --run-id S2-wdvit-unseeded)

# Scenario S4a - run final-p1/sc8-S4a
...
| Run id | final-p1/sc8-S4a |
| Date (UTC) | 2026-09-17T03:15:47.902548+00:00 |
| Host | systemvi |
...
```bash
# results dir
DIR=$(python/.venv/bin/python tools/calibration-protocol/newrun.py --scenario S4a --run-id final-p1/sc8-S4a)

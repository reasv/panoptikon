# Scenario S2 - run final-p1/sc8-S2
...
| Run id | final-p1/sc8-S2 |
| Date (UTC) | 2026-09-17T03:06:58.051992+00:00 |
| Host | systemvi |
...
```bash
# results dir
DIR=$(python/.venv/bin/python tools/calibration-protocol/newrun.py --scenario S2 --run-id final-p1/sc8-S2)

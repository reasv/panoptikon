# Scenario S2 - run final-p1/sc8-S2-vith
...
| Run id | final-p1/sc8-S2-vith |
| Date (UTC) | 2026-09-17T03:11:59.610911+00:00 |
| Host | systemvi |
...
```bash
# results dir
DIR=$(python/.venv/bin/python tools/calibration-protocol/newrun.py --scenario S2 --run-id final-p1/sc8-S2-vith)

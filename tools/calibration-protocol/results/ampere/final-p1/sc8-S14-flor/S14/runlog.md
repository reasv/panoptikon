# Scenario S14 - run final-p1/sc8-S14-flor
...
| Run id | final-p1/sc8-S14-flor |
| Date (UTC) | 2026-09-17T03:14:13.028902+00:00 |
| Host | systemvi |
...
```bash
# results dir
DIR=$(python/.venv/bin/python tools/calibration-protocol/newrun.py --scenario S14 --run-id final-p1/sc8-S14-flor)

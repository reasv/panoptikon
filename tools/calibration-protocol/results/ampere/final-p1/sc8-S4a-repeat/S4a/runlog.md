# Scenario S4a - run final-p1/sc8-S4a-repeat
...
| Run id | final-p1/sc8-S4a-repeat |
| Date (UTC) | 2026-09-17T03:18:31.723691+00:00 |
| Host | systemvi |
| Branch / commit | p1 / d3da925dc9d7a120d12fef9f4970c74b7cca050f |
...
```bash
# results dir
DIR=$(python/.venv/bin/python tools/calibration-protocol/newrun.py --scenario S4a --run-id final-p1/sc8-S4a-repeat)

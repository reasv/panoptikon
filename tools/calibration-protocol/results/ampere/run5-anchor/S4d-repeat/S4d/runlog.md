...
| Run id | S4d-repeat |
| Date (UTC) | 2026-09-16T21:41:39.903478+00:00 |
| Host | systemvi |
...
```bash
# results dir
DIR=$(python/.venv/bin/python tools/calibration-protocol/newrun.py --scenario S4d --run-id S4d-repeat)

...
| Run id | sc8-S2-vith |
| Date (UTC) | 2026-09-16T21:59:38.171019+00:00 |
| Host | systemvi |
...
```bash
# results dir
DIR=$(python/.venv/bin/python tools/calibration-protocol/newrun.py --scenario S2 --run-id sc8-S2-vith)

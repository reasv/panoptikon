...
| Run id | S4d-unseeded |
| Date (UTC) | 2026-09-16T21:48:35.608983+00:00 |
| Host | systemvi |
| Branch / commit | run5-anchor / c7130a19f14221c40e5a8ad08a641b0ea4372df9 |
...
```bash
# results dir
DIR=$(python/.venv/bin/python tools/calibration-protocol/newrun.py --scenario S4d --run-id S4d-unseeded)

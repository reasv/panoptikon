# Scenario S14-textembed - run run4-sm120
...
| Configuration | /home/admin/projects/panoptikon-wt/run4-local/tools/calibration-protocol/results/run4-sm120/config/server-C1r4x.toml (see protocol §3) |
| Run id | run4-sm120 |
| Date (UTC) | 2026-09-16T17:36:32.898569+00:00 |
| Host | gcs |
| Branch / commit | run4/local / 0d7f567185288d83974a1f10d21fff0e6e44677b |
...
```bash
# results dir
DIR=$(python/.venv/bin/python tools/calibration-protocol/newrun.py --scenario S14-textembed --run-id run4-sm120)

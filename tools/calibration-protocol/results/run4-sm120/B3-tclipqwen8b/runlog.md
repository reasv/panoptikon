# Scenario B3-tclipqwen8b - run run4-sm120
...
| Note | baseline sweep leg B3-tclipqwen8b |
...
```bash
# results dir
DIR=$(python/.venv/bin/python tools/calibration-protocol/newrun.py --scenario B3-tclipqwen8b --run-id run4-sm120)

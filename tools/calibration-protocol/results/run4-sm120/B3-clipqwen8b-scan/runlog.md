# Scenario B3-clipqwen8b-scan - run run4-sm120
...
| Note | baseline sweep leg B3-clipqwen8b-scan |
...
```bash
# results dir
DIR=$(python/.venv/bin/python tools/calibration-protocol/newrun.py --scenario B3-clipqwen8b-scan --run-id run4-sm120)

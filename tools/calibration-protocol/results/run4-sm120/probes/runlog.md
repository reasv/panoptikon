# Scenario probes - run run4-sm120
...
| Note | run4 sm120 regression pass |
...
```bash
# results dir
DIR=$(python/.venv/bin/python tools/calibration-protocol/newrun.py --scenario probes --run-id run4-sm120)

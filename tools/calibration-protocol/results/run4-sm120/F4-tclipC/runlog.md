# Scenario F4-tclipC - run run4-sm120
...
| Note | baseline sweep leg F4-tclipC |
...
```bash
# results dir
DIR=$(python/.venv/bin/python tools/calibration-protocol/newrun.py --scenario F4-tclipC --run-id run4-sm120)

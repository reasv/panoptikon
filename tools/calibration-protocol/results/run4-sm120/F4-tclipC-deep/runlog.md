# Scenario F4-tclipC-deep - run run4-sm120
...
| Note | baseline sweep leg F4-tclipC-deep |
...
```bash
# results dir
DIR=$(python/.venv/bin/python tools/calibration-protocol/newrun.py --scenario F4-tclipC-deep --run-id run4-sm120)

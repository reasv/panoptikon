# Scenario B3-stella400 - run run4-sm120
...
| Note | baseline sweep leg B3-stella400 |
...
```bash
# results dir
DIR=$(python/.venv/bin/python tools/calibration-protocol/newrun.py --scenario B3-stella400 --run-id run4-sm120)

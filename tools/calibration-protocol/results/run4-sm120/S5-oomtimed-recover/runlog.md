# Scenario S5-oomtimed-recover - run run4-sm120
...
| | |
|---|---|
| Scenario | S5-oomtimed-recover |
| Configuration | B3 (see protocol §3) |
| Run id | run4-sm120 |
...
| Note | baseline sweep leg S5-oomtimed-recover |
...
```bash
# results dir
DIR=$(python/.venv/bin/python tools/calibration-protocol/newrun.py --scenario S5-oomtimed-recover --run-id run4-sm120)

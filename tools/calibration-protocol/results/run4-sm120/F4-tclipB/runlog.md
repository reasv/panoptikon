# Scenario F4-tclipB - run run4-sm120
...
| Note | baseline sweep leg F4-tclipB |
...
```bash
# results dir
DIR=$(python/.venv/bin/python tools/calibration-protocol/newrun.py --scenario F4-tclipB --run-id run4-sm120)

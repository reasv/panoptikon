...
| Run id | fin-1 |
| Date (UTC) | 2026-09-17T00:59:59.291616+00:00 |
...
| Driver | None |
| GPUs | none |
| Note | final tip 2133563f wired 0: inventory, identity, total adoption |
...
```bash
# results dir
DIR=$(python/.venv/bin/python tools/calibration-protocol/newrun.py --scenario S1 --run-id fin-1)

...
| Run id | fin-3w |
| Date (UTC) | 2026-09-17T01:12:51.397752+00:00 |
...
| Driver | None |
| GPUs | none |
| Note | final tip 2133563f wired 0: warm restart on the wd-vit store |
...
```bash
# results dir
DIR=$(python/.venv/bin/python tools/calibration-protocol/newrun.py --scenario S3 --run-id fin-3w)

...
| Run id | fin-4d |
| Date (UTC) | 2026-09-17T01:45:06.961738+00:00 |
...
| Driver | None |
| GPUs | none |
| Note | final tip 2133563f wired 0: step down, hog released at t=120s |
...
```bash
# results dir
DIR=$(python/.venv/bin/python tools/calibration-protocol/newrun.py --scenario S4d --run-id fin-4d)

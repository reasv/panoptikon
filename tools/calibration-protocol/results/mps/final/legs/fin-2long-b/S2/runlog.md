...
| Run id | fin-2long-b |
| Date (UTC) | 2026-09-17T01:51:14.174007+00:00 |
...
| Driver | None |
| GPUs | none |
| Note | final tip 2133563f wired 0: R1 CLIP cold ramp b |
...
```bash
# results dir
DIR=$(python/.venv/bin/python tools/calibration-protocol/newrun.py --scenario S2 --run-id fin-2long-b)

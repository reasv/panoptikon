# Scenario S14-textembed - run fin-14te
...
| Run id | fin-14te |
| Date (UTC) | 2026-09-17T02:19:02.357183+00:00 |
...
```bash
# results dir
DIR=$(python/.venv/bin/python tools/calibration-protocol/newrun.py --scenario S14-textembed --run-id fin-14te)

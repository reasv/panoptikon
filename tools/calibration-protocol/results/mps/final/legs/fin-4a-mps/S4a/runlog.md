...
| Run id | fin-4a-mps |
| Date (UTC) | 2026-09-17T01:16:40.054991+00:00 |
...
| Driver | None |
| GPUs | none |
| Note | final tip 2133563f wired 0: constant MPS pressure, min-free 20480 |
...
```bash
# results dir
DIR=$(python/.venv/bin/python tools/calibration-protocol/newrun.py --scenario S4a --run-id fin-4a-mps)

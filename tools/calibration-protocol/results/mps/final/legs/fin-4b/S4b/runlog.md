...
| Run id | fin-4b |
| Date (UTC) | 2026-09-17T01:37:57.998160+00:00 |
...
| Driver | None |
| GPUs | none |
| Note | final tip 2133563f wired 0: step up, hog raised at t=60s (no run4 comparand) |
...
```bash
# results dir
DIR=$(python/.venv/bin/python tools/calibration-protocol/newrun.py --scenario S4b --run-id fin-4b)

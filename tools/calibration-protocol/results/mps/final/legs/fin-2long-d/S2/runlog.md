...
| Run id | fin-2long-d |
| Date (UTC) | 2026-09-17T01:56:26.244851+00:00 |
...
| Driver | None |
| GPUs | none |
| Note | final tip 2133563f wired 0: R1 CLIP cold ramp d |
...
```bash
# results dir
DIR=$(python/.venv/bin/python tools/calibration-protocol/newrun.py --scenario S2 --run-id fin-2long-d)

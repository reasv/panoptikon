...
| Run id | fin-14t |
| Date (UTC) | 2026-09-17T01:29:27.198867+00:00 |
...
| Driver | None |
| GPUs | none |
| Note | final tip 2133563f wired 0: S14 CI smoke + tags |
...
```bash
# results dir
DIR=$(python/.venv/bin/python tools/calibration-protocol/newrun.py --scenario S14 --run-id fin-14t)

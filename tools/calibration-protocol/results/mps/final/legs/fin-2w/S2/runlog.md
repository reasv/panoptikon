...
| Run id | fin-2w |
| Date (UTC) | 2026-09-17T01:01:21.924405+00:00 |
...
| Driver | None |
| GPUs | none |
| Note | final tip 2133563f wired 0: cold ramp on an idle GPU (hog-free external control) |
...
```bash
# results dir
DIR=$(python/.venv/bin/python tools/calibration-protocol/newrun.py --scenario S2 --run-id fin-2w)

...
| Run id | fin-4a-ram |
| Date (UTC) | 2026-09-17T01:22:53.281067+00:00 |
...
| Driver | None |
| GPUs | none |
| Note | final tip 2133563f wired 0: constant RAM pressure, min-free 20480 |
...
```bash
# results dir
DIR=$(python/.venv/bin/python tools/calibration-protocol/newrun.py --scenario S4a --run-id fin-4a-ram)

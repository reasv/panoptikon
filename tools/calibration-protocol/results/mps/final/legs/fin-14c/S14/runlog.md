...
| Run id | fin-14c |
| Date (UTC) | 2026-09-17T01:30:48.857542+00:00 |
...
| Driver | None |
| GPUs | none |
| Note | final tip 2133563f wired 0: S14 load-path clip |
...
```bash
# results dir
DIR=$(python/.venv/bin/python tools/calibration-protocol/newrun.py --scenario S14 --run-id fin-14c)

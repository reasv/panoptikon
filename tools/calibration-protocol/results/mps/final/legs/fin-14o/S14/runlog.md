...
| Run id | fin-14o |
| Date (UTC) | 2026-09-17T01:33:24.074415+00:00 |
...
| Driver | None |
| GPUs | none |
| Note | final tip 2133563f wired 0: S14 load-path doctr OCR |
...
```bash
# results dir
DIR=$(python/.venv/bin/python tools/calibration-protocol/newrun.py --scenario S14 --run-id fin-14o)

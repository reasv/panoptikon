...
| Run id | fin-14ch |
| Date (UTC) | 2026-09-17T01:35:37.969290+00:00 |
...
| Driver | None |
| GPUs | none |
| Note | final tip 2133563f wired 0: S14 derived-setter chain; Florence2 deliberately excluded |
...
```bash
# results dir
DIR=$(python/.venv/bin/python tools/calibration-protocol/newrun.py --scenario S14 --run-id fin-14ch)

...
| Run id | fin-3 |
| Date (UTC) | 2026-09-17T01:10:43.275846+00:00 |
...
| Driver | None |
| GPUs | none |
| Note | final tip 2133563f wired 0: warm restart on the CLIP store |
...
```bash
# results dir
DIR=$(python/.venv/bin/python tools/calibration-protocol/newrun.py --scenario S3 --run-id fin-3)

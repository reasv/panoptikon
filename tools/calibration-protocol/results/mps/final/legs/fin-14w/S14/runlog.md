...
| Run id | fin-14w |
| Date (UTC) | 2026-09-17T01:32:06.430966+00:00 |
...
| Driver | None |
| GPUs | none |
| Note | final tip 2133563f wired 0: S14 load-path whisper (CTranslate2 device on macOS) |
...
```bash
# results dir
DIR=$(python/.venv/bin/python tools/calibration-protocol/newrun.py --scenario S14 --run-id fin-14w)

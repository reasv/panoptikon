...
| Run id | fin-2long |
| Date (UTC) | 2026-09-17T01:03:45.843020+00:00 |
...
| Driver | None |
| GPUs | none |
| Note | final tip 2133563f wired 0: ramp4 8000 items, R1 repeat a |
...
```bash
# results dir
DIR=$(python/.venv/bin/python tools/calibration-protocol/newrun.py --scenario S2 --run-id fin-2long)

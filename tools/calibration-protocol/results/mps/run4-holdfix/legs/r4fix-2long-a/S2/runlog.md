...
| Run id | r4fix-2long-a |
| Date (UTC) | 2026-09-16T19:53:58.258728+00:00 |
...
| Driver | None |
| GPUs | none |
| Note | fix/early-hold 4f8ea91a: R1 CLIP cold ramp control a |
...
```bash
# results dir
DIR=$(python/.venv/bin/python tools/calibration-protocol/newrun.py --scenario S2 --run-id r4fix-2long-a)

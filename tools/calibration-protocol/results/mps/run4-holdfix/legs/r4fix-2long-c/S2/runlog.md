...
| Run id | r4fix-2long-c |
| Date (UTC) | 2026-09-16T19:59:10.334194+00:00 |
...
| Driver | None |
| GPUs | none |
| Note | fix/early-hold 4f8ea91a: R1 CLIP cold ramp control c |
...
```bash
# results dir
DIR=$(python/.venv/bin/python tools/calibration-protocol/newrun.py --scenario S2 --run-id r4fix-2long-c)

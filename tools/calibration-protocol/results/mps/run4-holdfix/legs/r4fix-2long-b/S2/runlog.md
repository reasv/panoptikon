...
|---|---|
| Scenario | S2 |
| Configuration | .mac/server-C1-mac.toml (see protocol §3) |
| Run id | r4fix-2long-b |
| Date (UTC) | 2026-09-16T19:56:34.323626+00:00 |
| Host | MacBook-Pro.local |
| Branch / commit | verify-early-hold / 4f8ea91ac751defa975871cea626b2e7813001af |
...
| Driver | None |
| GPUs | none |
| Note | fix/early-hold 4f8ea91a: R1 CLIP cold ramp control b |
...
```bash
# results dir
DIR=$(python/.venv/bin/python tools/calibration-protocol/newrun.py --scenario S2 --run-id r4fix-2long-b)

...
| Run id | r4-4a-ram |
| Date (UTC) | 2026-09-16T18:02:36.105013+00:00 |
...
| Driver | None |
| GPUs | none |
| Note | run4 tip 0d7f5671 wired 0: constant RAM pressure, min-free 20480 |
...
```bash
# results dir
DIR=$(python/.venv/bin/python tools/calibration-protocol/newrun.py --scenario S4a --run-id r4-4a-ram)

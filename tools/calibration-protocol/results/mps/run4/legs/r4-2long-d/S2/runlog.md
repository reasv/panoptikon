...
| Run id | r4-2long-d |
| Date (UTC) | 2026-09-16T18:30:09.296475+00:00 |
...
| Driver | None |
| GPUs | none |
| Note | run4 tip 0d7f5671 wired 0: CLIP cold ramp, R1 repeat d |
...
```bash
# results dir
DIR=$(python/.venv/bin/python tools/calibration-protocol/newrun.py --scenario S2 --run-id r4-2long-d)

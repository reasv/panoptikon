...
| Run id | r4-4a-mps |
| Date (UTC) | 2026-09-16T17:55:48.730036+00:00 |
| Host | MacBook-Pro.local |
| Branch / commit | run4-mac / 0d7f567185288d83974a1f10d21fff0e6e44677b |
...
| Driver | None |
| GPUs | none |
| Note | run4 tip 0d7f5671 wired 0: constant MPS pressure, min-free 20480 |
...
```bash
# results dir
DIR=$(python/.venv/bin/python tools/calibration-protocol/newrun.py --scenario S4a --run-id r4-4a-mps)

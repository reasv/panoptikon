...
| Run id | r4-3w |
| Date (UTC) | 2026-09-16T17:51:52.007739+00:00 |
...
```bash
# results dir
DIR=$(python/.venv/bin/python tools/calibration-protocol/newrun.py --scenario S3 --run-id r4-3w)

...
| Run id | r4-14t |
| Date (UTC) | 2026-09-16T18:15:01.615725+00:00 |
...
```bash
# results dir
DIR=$(python/.venv/bin/python tools/calibration-protocol/newrun.py --scenario S14 --run-id r4-14t)

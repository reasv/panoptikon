...
| Run id | r4-14o |
| Date (UTC) | 2026-09-16T18:19:00.674046+00:00 |
...
```bash
# results dir
DIR=$(python/.venv/bin/python tools/calibration-protocol/newrun.py --scenario S14 --run-id r4-14o)

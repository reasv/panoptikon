...
| Run id | r4-4d |
| Date (UTC) | 2026-09-16T18:08:50.488260+00:00 |
...
| Driver | None |
| GPUs | none |
| Note | run4 tip 0d7f5671 wired 0: step down, hog released at t=120s |
...
```bash
# results dir
DIR=$(python/.venv/bin/python tools/calibration-protocol/newrun.py --scenario S4d --run-id r4-4d)

...
| Run id | r4-14ch |
| Date (UTC) | 2026-09-16T18:21:14.640247+00:00 |
...
```bash
# results dir
DIR=$(python/.venv/bin/python tools/calibration-protocol/newrun.py --scenario S14 --run-id r4-14ch)

...
| Run id | r4-14w |
| Date (UTC) | 2026-09-16T18:17:42.996448+00:00 |
...
```bash
# results dir
DIR=$(python/.venv/bin/python tools/calibration-protocol/newrun.py --scenario S14 --run-id r4-14w)

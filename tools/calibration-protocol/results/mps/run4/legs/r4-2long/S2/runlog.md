...
| Run id | r4-2long |
| Date (UTC) | 2026-09-16T17:42:35.468851+00:00 |
...
```bash
# results dir
DIR=$(python/.venv/bin/python tools/calibration-protocol/newrun.py --scenario S2 --run-id r4-2long)

# Scenario S4a - run f-wdvit-S4a12
...
| Run id | f-wdvit-S4a12 |
| Date (UTC) | 2026-09-17T02:30:06.161238+00:00 |
| Host | A-DESKTOP |
...
```bash
# results dir
DIR=$(python/.venv/bin/python tools/calibration-protocol/newrun.py --scenario S4a --run-id f-wdvit-S4a12)

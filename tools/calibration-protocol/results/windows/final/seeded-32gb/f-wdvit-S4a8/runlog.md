...
| Run id | f-wdvit-S4a8 |
| Date (UTC) | 2026-09-17T02:31:47.951255+00:00 |
| Host | A-DESKTOP |
...
```bash
# results dir
DIR=$(python/.venv/bin/python tools/calibration-protocol/newrun.py --scenario S4a --run-id f-wdvit-S4a8)

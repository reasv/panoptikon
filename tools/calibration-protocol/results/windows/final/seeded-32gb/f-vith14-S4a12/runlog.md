# Scenario S4a - run f-vith14-S4a12
...
| Run id | f-vith14-S4a12 |
| Date (UTC) | 2026-09-17T02:33:33.641911+00:00 |
| Host | A-DESKTOP |
...
```bash
# results dir
DIR=$(python/.venv/bin/python tools/calibration-protocol/newrun.py --scenario S4a --run-id f-vith14-S4a12)

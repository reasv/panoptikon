...
| Run id | f-vith14-S2 |
| Date (UTC) | 2026-09-17T02:11:58.118729+00:00 |
| Host | A-DESKTOP |
...
```bash
# results dir
DIR=$(python/.venv/bin/python tools/calibration-protocol/newrun.py --scenario S2 --run-id f-vith14-S2)

# Scenario S5 - run f-S5-failbatch_oomtext
...
| Run id | f-S5-failbatch_oomtext |
| Date (UTC) | 2026-09-17T01:55:47.189699+00:00 |
| Host | A-DESKTOP |
...
```bash
# results dir
DIR=$(python/.venv/bin/python tools/calibration-protocol/newrun.py --scenario S5 --run-id f-S5-failbatch_oomtext)

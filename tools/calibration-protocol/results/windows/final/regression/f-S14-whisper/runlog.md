# Scenario S14 - run f-S14-whisper
...
| Run id | f-S14-whisper |
| Date (UTC) | 2026-09-17T02:36:35.644670+00:00 |
| Host | A-DESKTOP |
...
```bash
# results dir
DIR=$(python/.venv/bin/python tools/calibration-protocol/newrun.py --scenario S14 --run-id f-S14-whisper)

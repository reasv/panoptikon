# Scenario S14-textembed - run f-S14-textembed
...
| Run id | f-S14-textembed |
| Date (UTC) | 2026-09-17T02:03:24.130550+00:00 |
| Host | A-DESKTOP |
| Branch / commit | final-tip / 2133563f722478822d17b62430a19e363f47cbd6 |
...
```bash
# results dir
DIR=$(python/.venv/bin/python tools/calibration-protocol/newrun.py --scenario S14-textembed --run-id f-S14-textembed)

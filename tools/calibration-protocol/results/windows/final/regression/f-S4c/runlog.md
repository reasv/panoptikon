...
| Run id | f-S4c |
| Date (UTC) | 2026-09-17T01:23:57.244333+00:00 |
| Host | A-DESKTOP |
...
```bash
# results dir
DIR=$(python/.venv/bin/python tools/calibration-protocol/newrun.py --scenario S4c --run-id f-S4c)

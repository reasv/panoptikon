# Scenario S5 - run f-S5-failbatch
...
| Run id | f-S5-failbatch |
| Date (UTC) | 2026-09-17T01:53:54.762000+00:00 |
| Host | A-DESKTOP |
...
```bash
# results dir
DIR=$(python/.venv/bin/python tools/calibration-protocol/newrun.py --scenario S5 --run-id f-S5-failbatch)

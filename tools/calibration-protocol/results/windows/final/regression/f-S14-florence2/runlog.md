# Scenario S14 - run f-S14-florence2
...
| Run id | f-S14-florence2 |
| Date (UTC) | 2026-09-17T02:02:13.346214+00:00 |
| Host | A-DESKTOP |
...
```bash
# results dir
DIR=$(python/.venv/bin/python tools/calibration-protocol/newrun.py --scenario S14 --run-id f-S14-florence2)

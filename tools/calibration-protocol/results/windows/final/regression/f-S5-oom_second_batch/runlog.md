# Scenario S5 - run f-S5-oom_second_batch
...
| Run id | f-S5-oom_second_batch |
| Date (UTC) | 2026-09-17T01:57:39.636532+00:00 |
| Host | A-DESKTOP |
...
```bash
# results dir
DIR=$(python/.venv/bin/python tools/calibration-protocol/newrun.py --scenario S5 --run-id f-S5-oom_second_batch)

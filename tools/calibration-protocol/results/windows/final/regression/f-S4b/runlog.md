...
| Run id | f-S4b |
| Date (UTC) | 2026-09-17T01:16:11.890678+00:00 |
| Host | A-DESKTOP |
...
```bash
# results dir
DIR=$(python/.venv/bin/python tools/calibration-protocol/newrun.py --scenario S4b --run-id f-S4b)

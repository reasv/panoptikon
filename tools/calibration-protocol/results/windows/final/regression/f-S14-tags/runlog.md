...
| Run id | f-S14-tags |
| Date (UTC) | 2026-09-17T01:58:30.285976+00:00 |
| Host | A-DESKTOP |
...
```bash
# results dir
DIR=$(python/.venv/bin/python tools/calibration-protocol/newrun.py --scenario S14 --run-id f-S14-tags)

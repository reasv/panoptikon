...
| Run id | r4-S3 |
| Date (UTC) | 2026-09-16T19:52:03.686474+00:00 |
| Host | A-DESKTOP |
...
```bash
# results dir
DIR=$(python/.venv/bin/python tools/calibration-protocol/newrun.py --scenario S3 --run-id r4-S3)

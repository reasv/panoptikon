# Scenario S5 - run r4-S5-failbatch_oomtext
...
| Run id | r4-S5-failbatch_oomtext |
| Date (UTC) | 2026-09-16T20:26:02.216875+00:00 |
| Host | A-DESKTOP |
...
```bash
# results dir
DIR=$(python/.venv/bin/python tools/calibration-protocol/newrun.py --scenario S5 --run-id r4-S5-failbatch_oomtext)

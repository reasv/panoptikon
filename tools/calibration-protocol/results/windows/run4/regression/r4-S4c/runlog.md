...
| Run id | r4-S4c |
| Date (UTC) | 2026-09-16T20:11:06.535439+00:00 |
| Host | A-DESKTOP |
...
```bash
# results dir
DIR=$(python/.venv/bin/python tools/calibration-protocol/newrun.py --scenario S4c --run-id r4-S4c)

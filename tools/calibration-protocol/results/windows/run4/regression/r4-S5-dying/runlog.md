...
| Run id | r4-S5-dying |
| Date (UTC) | 2026-09-16T20:23:07.016522+00:00 |
| Host | A-DESKTOP |
...
```bash
# results dir
DIR=$(python/.venv/bin/python tools/calibration-protocol/newrun.py --scenario S5 --run-id r4-S5-dying)

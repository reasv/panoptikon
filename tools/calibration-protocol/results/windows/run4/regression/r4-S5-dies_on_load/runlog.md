# Scenario S5 - run r4-S5-dies_on_load
...
| Run id | r4-S5-dies_on_load |
| Date (UTC) | 2026-09-16T20:22:16.505521+00:00 |
| Host | A-DESKTOP |
...
```bash
# results dir
DIR=$(python/.venv/bin/python tools/calibration-protocol/newrun.py --scenario S5 --run-id r4-S5-dies_on_load)

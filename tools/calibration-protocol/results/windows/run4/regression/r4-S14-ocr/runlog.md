...
| Run id | r4-S14-ocr |
| Date (UTC) | 2026-09-16T20:30:34.251289+00:00 |
| Host | A-DESKTOP |
...
```bash
# results dir
DIR=$(python/.venv/bin/python tools/calibration-protocol/newrun.py --scenario S14 --run-id r4-S14-ocr)

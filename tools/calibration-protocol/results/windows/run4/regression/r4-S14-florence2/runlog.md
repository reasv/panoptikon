# Scenario S14 - run r4-S14-florence2
...
| Run id | r4-S14-florence2 |
| Date (UTC) | 2026-09-16T20:32:23.196804+00:00 |
| Host | A-DESKTOP |
...
```bash
# results dir
DIR=$(python/.venv/bin/python tools/calibration-protocol/newrun.py --scenario S14 --run-id r4-S14-florence2)

# Scenario S5 - run r4-S5-oom_second_batch
...
| Run id | r4-S5-oom_second_batch |
| Date (UTC) | 2026-09-16T20:27:55.065098+00:00 |
| Host | A-DESKTOP |
...
```bash
# results dir
DIR=$(python/.venv/bin/python tools/calibration-protocol/newrun.py --scenario S5 --run-id r4-S5-oom_second_batch)

...
| Run id | r4-S4a |
| Date (UTC) | 2026-09-16T19:54:32.918353+00:00 |
| Host | A-DESKTOP |
...
```bash
# results dir
DIR=$(python/.venv/bin/python tools/calibration-protocol/newrun.py --scenario S4a --run-id r4-S4a)

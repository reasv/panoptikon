# Scenario S14 - run r4-S14-whisper
...
| Run id | r4-S14-whisper |
| Date (UTC) | 2026-09-16T20:31:30.696227+00:00 |
| Host | A-DESKTOP |
...
```bash
# results dir
DIR=$(python/.venv/bin/python tools/calibration-protocol/newrun.py --scenario S14 --run-id r4-S14-whisper)

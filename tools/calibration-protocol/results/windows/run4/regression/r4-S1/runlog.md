...
| Run id | r4-S1 |
| Date (UTC) | 2026-09-16T19:49:26.584033+00:00 |
| Host | A-DESKTOP |
...
```bash
# results dir
DIR=$(python/.venv/bin/python tools/calibration-protocol/newrun.py --scenario S1 --run-id r4-S1)

...
| Run id | r4-S4d |
| Date (UTC) | 2026-09-16T20:15:07.064151+00:00 |
| Host | A-DESKTOP |
...
```bash
# results dir
DIR=$(python/.venv/bin/python tools/calibration-protocol/newrun.py --scenario S4d --run-id r4-S4d)

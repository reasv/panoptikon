# Scenario S5 - run r4-S5-failbatch
...
| Run id | r4-S5-failbatch |
| Date (UTC) | 2026-09-16T20:24:05.571481+00:00 |
| Host | A-DESKTOP |
...
```bash
# results dir
DIR=$(python/.venv/bin/python tools/calibration-protocol/newrun.py --scenario S5 --run-id r4-S5-failbatch)

# Scenario S14-textembed - run r4-S14-textembed
...
| Configuration | Q:\projects\panoptikon-pr27\tools\calibration-protocol\config\server-C1win.toml (see protocol §3) |
| Run id | r4-S14-textembed |
| Date (UTC) | 2026-09-16T20:33:37.777411+00:00 |
| Host | A-DESKTOP |
| Branch / commit | tip-final / 0d7f567185288d83974a1f10d21fff0e6e44677b |
...
| Driver | 610.74 |
| GPUs | 0:NVIDIA GeForce RTX 5090 32607 MiB, 1:NVIDIA GeForce RTX 5090 32607 MiB |
...
```bash
# results dir
DIR=$(python/.venv/bin/python tools/calibration-protocol/newrun.py --scenario S14-textembed --run-id r4-S14-textembed)

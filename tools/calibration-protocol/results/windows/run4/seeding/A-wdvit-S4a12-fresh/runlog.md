# Scenario S4a - run A-wdvit-S4a12-fresh
...
| Run id | A-wdvit-S4a12-fresh |
| Date (UTC) | 2026-09-16T19:15:20.958399+00:00 |
| Host | A-DESKTOP |
...
```bash
# results dir
DIR=$(python/.venv/bin/python tools/calibration-protocol/newrun.py --scenario S4a --run-id A-wdvit-S4a12-fresh)

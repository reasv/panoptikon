# Scenario S4a - run A-vith14-S4a12-seed
...
| Run id | A-vith14-S4a12-seed |
| Date (UTC) | 2026-09-16T19:27:04.793298+00:00 |
| Host | A-DESKTOP |
...
```bash
# results dir
DIR=$(python/.venv/bin/python tools/calibration-protocol/newrun.py --scenario S4a --run-id A-vith14-S4a12-seed)

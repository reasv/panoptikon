# Scenario S2 - run A-vith14-S2-seed
...
| Run id | A-vith14-S2-seed |
| Date (UTC) | 2026-09-16T19:24:18.693032+00:00 |
| Host | A-DESKTOP |
...
```bash
# results dir
DIR=$(python/.venv/bin/python tools/calibration-protocol/newrun.py --scenario S2 --run-id A-vith14-S2-seed)

# Scenario S2 - run A-vith14-S2-fresh
...
| Run id | A-vith14-S2-fresh |
| Date (UTC) | 2026-09-16T19:22:03.576589+00:00 |
| Host | A-DESKTOP |
...
```bash
# results dir
DIR=$(python/.venv/bin/python tools/calibration-protocol/newrun.py --scenario S2 --run-id A-vith14-S2-fresh)

# Scenario S4a - run A-wdvit-S4a8-fresh
...
| Run id | A-wdvit-S4a8-fresh |
| Date (UTC) | 2026-09-16T19:18:40.297316+00:00 |
| Host | A-DESKTOP |
...
```bash
# results dir
DIR=$(python/.venv/bin/python tools/calibration-protocol/newrun.py --scenario S4a --run-id A-wdvit-S4a8-fresh)

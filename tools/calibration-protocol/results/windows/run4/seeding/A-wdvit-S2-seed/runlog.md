# Scenario S2 - run A-wdvit-S2-seed
...
| Run id | A-wdvit-S2-seed |
| Date (UTC) | 2026-09-16T19:13:44.299214+00:00 |
| Host | A-DESKTOP |
...
```bash
# results dir
DIR=$(python/.venv/bin/python tools/calibration-protocol/newrun.py --scenario S2 --run-id A-wdvit-S2-seed)

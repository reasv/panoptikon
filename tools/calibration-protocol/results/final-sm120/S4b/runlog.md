...
| Note | step up: the hog takes another ~31% of the board 60 s into the job, between windows |
...
```bash
# results dir
DIR=$(python/.venv/bin/python tools/calibration-protocol/newrun.py --scenario S4b --run-id final-sm120)

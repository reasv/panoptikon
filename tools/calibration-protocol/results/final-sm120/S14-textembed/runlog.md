# Scenario S14-textembed - run final-sm120
...
| | |
|---|---|
| Scenario | S14-textembed |
| Configuration | /home/admin/projects/panoptikon-wt/final-local/tools/calibration-protocol/results/final-sm120/config/server-C1F.toml (see protocol §3) |
| Run id | final-sm120 |
| Date (UTC) | 2026-09-17T01:00:13.166225+00:00 |
| Host | gcs |
| Branch / commit | final/local / 2133563f722478822d17b62430a19e363f47cbd6 |
...
| Driver | 590.48.01 |
| GPUs | 0:NVIDIA RTX PRO 6000 Blackwell Workstation Edition 97887 MiB, 1:NVIDIA RTX PRO 6000 Blackwell Workstation Edition 97887 MiB |
| Note | regression sanity for a derived text setter: OCR the text tier's scanned pages, then embed the rows the OCR wrote |
...
```bash
# results dir
DIR=$(python/.venv/bin/python tools/calibration-protocol/newrun.py --scenario S14-textembed --run-id final-sm120)

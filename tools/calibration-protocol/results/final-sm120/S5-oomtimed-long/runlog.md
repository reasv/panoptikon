...
| Note | OOM backstop: a fault-injection fixture, whose failures must be absorbed without losing the job |
...
```bash
# results dir
DIR=$(python/.venv/bin/python tools/calibration-protocol/newrun.py --scenario S5 --run-id final-sm120)

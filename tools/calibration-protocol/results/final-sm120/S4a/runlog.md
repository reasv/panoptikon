...
| Note | constant external pressure: the hog holds the board down to a fixed free level for the whole job |
...
```bash
# results dir
DIR=$(python/.venv/bin/python tools/calibration-protocol/newrun.py --scenario S4a --run-id final-sm120)

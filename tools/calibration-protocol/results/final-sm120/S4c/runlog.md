...
| Note | spike: the hog squeezes the board to ~2 GB free for 10 s at t = 90 s, then releases |
...
```bash
# results dir
DIR=$(python/.venv/bin/python tools/calibration-protocol/newrun.py --scenario S4c --run-id final-sm120)
